...
#include <jni.h>
/* Header for class live_ablo_agora_data_MediaPreProcessing */

#ifndef _Included_live_ablo_agora_data_MediaPreProcessing
#define _Included_live_ablo_agora_data_MediaPreProcessing
#ifdef __cplusplus
extern "C" {
#endif
/*
 * Class:     live_ablo_agora_data_MediaPreProcessing
 * Method:    setCallback
