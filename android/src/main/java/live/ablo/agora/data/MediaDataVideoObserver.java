...
public interface MediaDataVideoObserver {
	...
	void onPreEncodeVideoFrame(byte[] buf, int videoFrameType, int width, int height, int bufferLength, int yStride, int uStride, int vStride, int rotation, long renderTimeMs);
