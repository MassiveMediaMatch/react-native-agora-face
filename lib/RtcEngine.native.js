...
class RtcEngine {
    ...
    */
     ...
     * @param muted
     */
    static muteLocalVideoStream(options) {
     ...
     * @param muted
     */
    static muteRemoteVideoStream(options) {
     ...
     * @param muted
     */
    static muteRemoteAudioStream(options) {
     ...
     * @param enabled
     */
    static muteLocalAudioStream(options) {
