...
class RtcEngine {
    ...
    /**
    * Take screenshot of a remote stream
    *
    *
    * @param int uid
    * @returns Promise<{success, imagePath}>
    */
    static takeScreenshot(uid) {
        return ReactNativeAgoraFace.takeScreenshot(uid);
    }
    /**
    * Remove screenshots
    *
    ...
    */
     static removeScreenshots(screenshots) {
        return ReactNativeAgoraFace.removeScreenshots(screenshots);
    }
    /**
